...
<html lang="en">
  <head>
    ...
    <title>Halo Store | Chính sách giao hàng</title>
  ...
  <!-- END SCROLL TOP BUTTON -->
   ...
   <?php require_once __DIR__ ."/header.php" ?>s
  <!-- / menu -->  
          ...
          <div class="aa-product-catg-content">
            <div class="aa-product-catg-head">
              <div class="aa-product-catg-head-left">
                <h1 style="font-weight: bold;">CHÍNH SÁCH GIAO HÀNG CỦA HALO</h1>
                 <p>Cập nhật ngày : 10/5/2019</p>
              </div>
              <div class="aa-product-kv" style="display: inline-block;">
                
               
                <h3 >Chính sách giao hàng</h3>
                <p>halo có chính sách giao hàng tận nơi trên toàn quốc, áp dụng cho khách hàng mua hàng trên website, fanpage và gọi điện thoại, không áp dụng cho khách mua trực tiếp tại cửa hàng <br /><br />
                  Đơn đặt hàng sẽ được chuyển phát đến tận địa chỉ khách hàng cung cấp thông qua công ty vận chuyển trung gian.
                </p>
                <h3>1.Thời gian giao hàng</h3>
                <p>&emsp; * Đơn hàng nội và ngoại thành TP.Huế <br /><br />
                  - Thời gian giao hàng là 1-2 ngày sau khi đặt hàng<br />
                  - Đơn hàng trước 11h30 trưa thì giao trong buổi chiều cùng ngày <br />
                  - Đơn hàng sau 11h30 sẽ được giao trong buổi tối và sáng hôm sau <br /><br />
                  &emsp;* Đơn hàng các tỉnh thành khác<br /><br />
                  - Thời gian là 2-3 ngày đối với các khu vực trung tâm thành phố, 3-7 ngày đối với các khu vực ngoại thành, huyện, xã, thị trấn...<br />
                  (Không tính thứ bảy, chủ nhật hay các ngày lễ tết)<br />
                  - Thời gian xữ lý đơn hàng sẽ được tính từ khi nhận được thanh toán của quý khách.<br />
                  - Có thể thay đổi thời gian giao hàng nếu khách hàng yêu cầu và Halo chủ động đổi trong trường hợp chịu ảnh hưởng của thiên tai hoặc các sự kiện đặc biệt khác.<br />
                 ...
                 <h3 >2. Phí giao hàng</h3>
                  <p style="margin-bottom: 70px; border-bottom: 1px solid #ccc; padding-bottom: 20px;">
                  - Đơn hàng trên 1.000.000đ được miễn phí giao hàng (trừ những dịp khuyễn mãi lớn) <br />
                  - Đơn hàng dưới 1,000,000đ: phí 30,000đ áp dụng cho mọi khu vực <br />
                </p>
